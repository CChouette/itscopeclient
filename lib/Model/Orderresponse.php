 ...
 *
 * @category Class
 * @description Details zur Liste der &lt;a href&#x3D;\&quot;https://support.itscope.com/hc/de/articles/206814239\&quot;&gt;OpenTrans 2.1 ORDERRESPONSE&lt;/a&gt; Dokumente
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Orderresponse implements ModelInterface, ArrayAccess
{
    ...
    public function setTransactionId($transaction_id)
    {
        if (!is_null($transaction_id) && (strlen($transaction_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $transaction_id when calling Orderresponse., must be smaller than or equal to 36.');
        }
        if (!is_null($transaction_id) && (strlen($transaction_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $transaction_id when calling Orderresponse., must be bigger than or equal to 0.');
        }
    ...
    public function setDocumentUrl($document_url)
    {
        if (!is_null($document_url) && (strlen($document_url) > 255)) {
            throw new \InvalidArgumentException('invalid length for $document_url when calling Orderresponse., must be smaller than or equal to 255.');
        }
        if (!is_null($document_url) && (strlen($document_url) < 0)) {
            throw new \InvalidArgumentException('invalid length for $document_url when calling Orderresponse., must be bigger than or equal to 0.');
        }
