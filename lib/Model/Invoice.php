...
class Invoice implements ModelInterface, ArrayAccess
{
    ...
    public function setTransactionId($transaction_id)
    {
        if (!is_null($transaction_id) && (strlen($transaction_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $transaction_id when calling Invoice., must be smaller than or equal to 36.');
        }
        if (!is_null($transaction_id) && (strlen($transaction_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $transaction_id when calling Invoice., must be bigger than or equal to 0.');
        }
    ...
    public function setDocumentUrl($document_url)
    {
        if (!is_null($document_url) && (strlen($document_url) > 255)) {
            throw new \InvalidArgumentException('invalid length for $document_url when calling Invoice., must be smaller than or equal to 255.');
        }
        if (!is_null($document_url) && (strlen($document_url) < 0)) {
            throw new \InvalidArgumentException('invalid length for $document_url when calling Invoice., must be bigger than or equal to 0.');
        }
